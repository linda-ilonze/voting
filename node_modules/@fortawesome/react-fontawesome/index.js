...
function FontAwesomeIcon$1(props) {
  ...
  var compose = objectWithKey('compose', normalizeIconArgs(composeArgs));

  var renderedIcon = fontawesome.icon(icon, _extends({}, classes, transform, compose, {
    symbol: symbol
  }));
